# Cryptologia construction-support materials
...
- `VERIFICATION_METRICS_NOTE.md`: methods and interpretation limits for the two reported construction-verification datasets.
...
These files support construction and implementation verification. They do not show that public orientation scheduling is cryptanalytically superior to a static matrix layer. That separate question is studied in **Structural Limits of Orientation Scheduling in Byte-Local GF(2) Diffusion Layers**, currently under review, with code and results maintained at:
